...
class BootstrapPrompt {
	...
	public static function generate(): string {
		...
		return "## Onboarding Discovery Session\n\n"
			...
			. 'Use `sd-ai-agent/list-posts` to fetch recent posts and pages. '
			...
			. 'If WooCommerce is detected in Step 2, use `sd-ai-agent/list-posts` with '
			...
			. "Use `sd-ai-agent/memory-save` to save the following (separate calls):\n"
