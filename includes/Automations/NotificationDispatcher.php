...
class NotificationDispatcher {
	...
	public static function test( string $type, string $webhook_url ): array {
		...
		$log_data = [
			'status'            => 'success',
			'reply'             => __( 'This is a test notification from Superdav AI Agent. Your webhook is configured correctly.', 'gratis-ai-agent' ),
			'duration_ms'       => 0,
			'prompt_tokens'     => 0,
			'completion_tokens' => 0,
			'error_message'     => '',
		...
		return [
			'attachments' => [
				[
					...
					'text'      => $reply,
					'fields'    => $fields,
					'footer'    => __( 'Superdav AI Agent', 'gratis-ai-agent' ),
					'ts'        => time(),
		...
		return [
			'embeds' => [
				[
					...
					'fields'    => $fields,
					'footer'    => [
						'text' => __( 'Superdav AI Agent', 'gratis-ai-agent' ),
					],
					'timestamp' => gmdate( 'c' ),
				],
			],
