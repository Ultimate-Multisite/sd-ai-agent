...
class BenchmarkSuite {
	...
	public static function list_suites(): array {
		return array(
			array(
				'slug'           => 'wp-core-v1',
				'name'           => __( 'WordPress Core v1', 'superdav-ai-agent' ),
				'description'    => __( 'Tests knowledge of WordPress core APIs, hooks, coding standards, and best practices.', 'superdav-ai-agent' ),
				'question_count' => count( self::get_wp_core_questions() ),
			),
			array(
				'slug'           => 'wp-quick',
				'name'           => __( 'WordPress Quick Test', 'superdav-ai-agent' ),
				'description'    => __( 'A quick 5-question test for rapid model evaluation.', 'superdav-ai-agent' ),
				'question_count' => 5,
			),
			array(
				'slug'           => 'agent-capabilities-v1',
				'name'           => __( 'Agent Capabilities v1', 'superdav-ai-agent' ),
				'description'    => __( 'Tests complex reasoning, code generation, debugging, multi-step problem solving, and architecture decisions. Designed to differentiate capable models like Opus from simpler ones.', 'superdav-ai-agent' ),
