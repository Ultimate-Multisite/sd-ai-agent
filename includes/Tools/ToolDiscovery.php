...
class ToolDiscovery {
	...
	public static function register_js_category(): void {
		...
		wp_register_ability_category(
			'gratis-ai-agent-js',
			array(
				'label'       => __( 'Superdav AI Agent (Client)', 'gratis-ai-agent' ),
				'description' => __( 'Client-side abilities provided by the Superdav AI Agent plugin. Execute in the browser without a server round-trip.', 'gratis-ai-agent' ),
			)
		);
	}
