...
use GratisAiAgent\Core\ToolResultTruncator;
use WP_UnitTestCase;
...
class ToolResultTruncatorTest extends WP_UnitTestCase {
	...
	public function test_get_plugins_strategy_keeps_essential_fields(): void {
		...
		$result = ToolResultTruncator::truncate( $input, 'gratis-ai-agent/get-plugins' );
	...
	public function test_db_query_strategy_truncates_rows(): void {
		...
		$result = ToolResultTruncator::truncate( $input, 'gratis-ai-agent/db-query' );
	...
	public function test_navigate_strategy_truncates_html(): void {
		...
		$result = ToolResultTruncator::truncate( $input, 'gratis-ai-agent/navigate' );
	...
	public function test_get_page_html_strategy_truncates_content(): void {
		...
		$result = ToolResultTruncator::truncate( $input, 'gratis-ai-agent/get-page-html' );
