...
export const selectors = {
	 ...
	 * @return {import('../types').Session[]} Session list.
	 */
	getSessions( state ) {
	...
	/**
	 * @param {import('../types').StoreState} state
	 * @return {import('../types').Message[]} Messages in the active session.
	 */
	...
	/**
	 * @param {import('../types').StoreState} state
	 * @return {import('../types').ToolCall[]} Tool calls in the active session.
	 */
	...
	/**
	 * @param {import('../types').StoreState} state
	 * @return {import('../types').Session[]} Sessions shared with all admins.
	 */
