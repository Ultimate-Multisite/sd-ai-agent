              ...
              <tbody>
                {Object.values(byModel).map((model) => (
                  <tr key={model.model_id}>
                    ...
                    <td>
                      {model.provider_id || __("Default", "gratis-ai-agent")}
                    </td>
                    <td>{model.total}</td>
                    <td>{model.correct}</td>
                    <td>{Math.round((model.correct / model.total) * 100)}%</td>
                  </tr>
                ))}
              </tbody>
            </table>
              ...
              <tbody>
                {Object.values(byCategory).map((cat) => (
                  <tr key={cat.category}>
                    ...
                    <td>{cat.total}</td>
                    <td>{cat.correct}</td>
                    <td>{Math.round((cat.correct / cat.total) * 100)}%</td>
                  </tr>
                ))}
              </tbody>
            </table>
