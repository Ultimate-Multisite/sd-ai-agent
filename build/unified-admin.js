...
function SettingsApp() {
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_22__.jsxs)("div", {
    ...
    children: [notice && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_22__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.Notice, {
      ...
      children: [(0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Provider API keys are configured network-wide on the Connectors page.', 'gratis-ai-agent'), ' ', /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_22__.jsx)("a", {
    ...
    }), !SELF_SAVING_TABS.includes(activeTab) && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_22__.jsx)("div", {
...
const actions = {
  ...
  streamMessage(message, attachments = []) {
    return async ({
      ...
      const clientAbilities = await (0,_abilities_registry__WEBPACK_IMPORTED_MODULE_2__.snapshotDescriptors)();
      ...
      if (result?.pending_client_tool_calls?.length) {
        ...
        for (const call of pendingCalls) {
          try {
            let callResult;
            if (typeof wp !== 'undefined' && wp.data && wp.data.dispatch('core/abilities') && typeof wp.data.dispatch('core/abilities').executeAbility === 'function') {
              callResult = await wp.data.dispatch('core/abilities').executeAbility(call.name, call.args || {});
            } else {
              // Fallback: look up and call the ability directly.
              const abilityStore = wp?.data?.select('core/abilities');
              const abilities = abilityStore?.getAbilities?.() || [];
              const ability = abilities.find(a => a.name === call.name);
              if (ability?.callback) {
                callResult = ability.callback(call.args || {});
              } else {
                throw new Error(`Ability ${call.name} not found`);
              }
            }
            toolResults.push({
              id: call.id,
            ...
            toolResults.push({
              id: call.id,
              name: call.name,
              error: err?.message || 'Client ability execution failed',
              ran_in_browser: true
            });
          }
        }
        ...
        let resumeResult;
        try {
          resumeResult = await _wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_0___default()({
          ...
          dispatch.appendMessage({
            role: 'system',
            parts: [{
              text: `${(0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Error:', 'gratis-ai-agent')} ${err.message || (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Failed to resume after client tool execution', 'gratis-ai-agent')}`
            }]
          });
          dispatch.setStreamError(true);
          dispatch.setSending(false);
        ...
        if (toolResults.length > 0) {
          const clientToolCallLog = toolResults.flatMap(tr => [{
            ...
            id: tr.id,
            name: tr.name,
            args: pendingCalls.find(c => c.id === tr.id)?.args || {},
            ran_in_browser: true
          }, {
            type: 'response',
            id: tr.id,
          ...
          if (result) {
            result = {
              ...result,
              tool_calls: [...(result.tool_calls || []), ...clientToolCallLog]
            };
          }
        }
      }
